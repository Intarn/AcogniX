...
import { educatorRoutes } from './educator.routes.jsx';
...
import CourseMaterials from "../pages/learner/CourseMaterials";
import CourseAnnouncements from "../pages/learner/CourseAnnouncements";
import CourseAssessments from "../pages/learner/CourseAssessments";
import AssessmentReview from "../pages/learner/AssessmentReview";
...
export const router = createBrowserRouter([
  ...
  // --- NHÓM ROUTE CHO LEARNER ---
  {
    ...
    children: [
      ...
      { path: "flashcards", element: <DeckManagement /> },
      { path: "flashcards/study", element: <Flashcards /> },
      { path: "quizzes", element: <Quiz /> },
      { path: "assessments", element: <Assessments /> },
      { path: "ai-quizzes", element: <AIPracticeQuizzes /> },
      { path: "ai-quizzes/study", element: <PracticeQuizViewer /> },
      { path: "notes", element: <Notes /> },
      { path: "courses/:courseId", element: <CourseDetail /> },
      { path: "courses/:courseId/materials", element: <CourseMaterials /> },
      { path: "courses/:courseId/announcements", element: <CourseAnnouncements /> },
      { path: "courses/:courseId/assessments", element: <CourseAssessments /> },
      { path: "courses/:courseId/assessments/:assessmentId/assignment", element: <AssignmentSubmission /> },
      { path: "courses/:courseId/assessments/:assessmentId/review", element: <AssessmentReview /> },
