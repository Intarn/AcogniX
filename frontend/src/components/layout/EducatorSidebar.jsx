// frontend/src/components/layout/EducatorSidebar.jsx
...
function navClass({ isActive }) {
  return isActive ? activeNavClass : normalNavClass;
}

function SectionLabel({ children }) {
  return (
    <p className="px-4 pt-5 pb-1 text-[10px] font-bold uppercase tracking-wider text-gray-400">
      {children}
    </p>
  );
}
    ...
    <aside className="w-60 h-full bg-white border-r border-gray-100 flex flex-col justify-between flex-shrink-0">
      <div>
        <div className="p-6 flex items-center gap-2.5">
          <svg width="34" height="34" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="educator-grad-leg" x1="50" y1="15" x2="80" y2="85" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#8B3DFF" />
                <stop offset="100%" stopColor="#6B21FF" />
              </linearGradient>
              <linearGradient id="educator-grad-left" x1="20" y1="85" x2="35" y2="50" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#00A3FF" />
                <stop offset="100%" stopColor="#3B82F6" />
              </linearGradient>
              <linearGradient id="educator-grad-swoosh" x1="25" y1="70" x2="95" y2="45" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#00C2FF" />
                <stop offset="50%" stopColor="#3B82F6" />
                <stop offset="100%" stopColor="#6B21FF" />
              </linearGradient>
            </defs>
            <path d="M 33 55 L 46 25 C 47.5 21.5 52.5 21.5 54 25 L 76 76" stroke="url(#educator-grad-leg)" strokeWidth="14" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M 22 80 L 26 70" stroke="url(#educator-grad-left)" strokeWidth="14" strokeLinecap="round" />
            <path d="M 26 65 C 50 78 70 70 92 48 C 65 68 45 74 24 73 Z" fill="url(#educator-grad-swoosh)" />
          </svg>
        ...
        <nav className="px-3 flex flex-col gap-1.5">
          <NavLink to="/educator/dashboard" className={navClass}>
          ...
          <NavLink to="/educator/courses" className={navClass}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink to="/educator/students" className={navClass}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink to="/educator/analytics" className={navClass}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink to="/educator/gradebook" className={navClass}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink to="/educator/support" className={navClass}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <NavLink to="/educator/settings" className={navClass}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="flex items-center gap-3 cursor-pointer">
          ...
          <NavLink to="/educator/settings" className="ml-auto flex-shrink-0">
